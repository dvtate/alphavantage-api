// AlphaVantage has a pretty weird way of giving data (random numbers in keys and stuff)
// this file removes a lot of the weird stuff
...
/**
   ...
   *   Normalized data.
   */
module.exports = function polish(data) {
